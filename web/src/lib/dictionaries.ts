...
const vi = {
  ...
  "admin.paywall_enabled": "Bật paywall",
  "admin.paywall_price": "Giá (VNĐ)",
  "admin.paywall_title_vi": "Tiêu đề (Tiếng Việt)",
  "admin.paywall_title_en": "Title (English)",
  "admin.paywall_desc_vi": "Mô tả (Tiếng Việt)",
  "admin.paywall_desc_en": "Description (English)",
  "admin.paywall_stations": "Tramm trả phí",
  "admin.paywall_stations_desc": "Chọn tramm yêu cầu thanh toán. Tramm không chọn = free.",
  "paywall.title": "Tramm yêu cầu thanh toán",
  "paywall.desc": "Trả phí một lần để mở khóa tramm này và tất cả tramm trả phí khác.",
  "paywall.price": "Giá: {price} VNĐ",
  "paywall.pay_now": "Thanh toán",
  "paywall.unlocked": "Đã mở khóa",
  "paywall.back": "Quay lại",
...
const en: Record<DictKey, string> = {
  ...
  "admin.paywall": "Paywall",
  "admin.paywall_enabled": "Enable paywall",
  "admin.paywall_price": "Price (VND)",
  "admin.paywall_title_vi": "Title (Vietnamese)",
  "admin.paywall_title_en": "Title (English)",
  "admin.paywall_desc_vi": "Description (Vietnamese)",
  "admin.paywall_desc_en": "Description (English)",
  "admin.paywall_stations": "Premium stations",
  "admin.paywall_stations_desc": "Select stations that require payment. Unselected = free.",
  "paywall.title": "Premium station",
  "paywall.desc": "Pay once to unlock this station and all other premium stations.",
  "paywall.price": "Price: {price} VND",
  "paywall.pay_now": "Pay now",
  "paywall.unlocked": "Unlocked",
  "paywall.back": "Go back",
